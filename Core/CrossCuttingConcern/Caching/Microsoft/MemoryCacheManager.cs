...
namespace Core.CrossCuttingConcern.Caching.Microsoft
{
    public class MemoryCacheManager : ICacheManager
    {
        ...
        IMemoryCache _memoryCache; //bunu injecte edebilmek için AddMemoryCache çalıştırdık coremodule da..

        public MemoryCacheManager()
        {
            // Core.DependencyResolvers/AddMemoryCache ile biz bunu zaten injete ekmiştik. Burada _memorycache e set ettik
